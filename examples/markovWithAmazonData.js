...
async function markovChain(){
    let amazonDataSetFile = await utils.readFileLineByLine('../dataset/250movies.txt')
    ...
    let markovChain = await markov.generate(amazonDataSetFile,200);
    //let markovChain = await markov.generate(ourDataSet, 200)
